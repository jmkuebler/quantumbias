...
for seed in tqdm(range(runs)):
    ...
    for i in range(max_qubits):
        qubits = i+1
        _, _, f, kernel_matrix_bias, kernel_second_qubit = get_functions(qubits=qubits, seed=seed, M='0', second_qubit=True)
...
np.save("data/loss_fm_10_runs_alpha_e-3", (qubits, full_train, full_test, bias_train, bias_test,
