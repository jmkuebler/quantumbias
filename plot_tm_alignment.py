...
for qubits in range(7, 8):
    bias, full, gauss, bias_wrong = np.load("data/tm_alignment_{0}_{1}_{2}.npy".format(qubits, samplesize, seed))
    ...
    plt.savefig("evaluations/tm_alignment_zero_mean_{0}_{1}_{2}.pdf".format(qubits, samplesize, seed),
                bbox_inches="tight")
    plt.close()
